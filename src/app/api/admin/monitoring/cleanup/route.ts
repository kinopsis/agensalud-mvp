...
export async function GET(request: NextRequest) {
  try {
    ...
    return createBuildSafeResponse(
      'Monitoring Cleanup GET endpoint is available',
      {
        method: 'GET',
...
export async function POST(request: NextRequest) {
  try {
    ...
    return createBuildSafeResponse(
      'Monitoring Cleanup POST endpoint is available',
      {
        method: 'POST',
        body
      }
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return createBuildSafeResponse(
      'Monitoring Cleanup PUT endpoint is available',
      {
        method: 'PUT',
        body
      }
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return createBuildSafeResponse(
      'Monitoring Cleanup DELETE endpoint is available',
      {
        method: 'DELETE',
        params: Object.fromEntries(searchParams.entries())
      }
