...
export async function GET(request: NextRequest) {
  try {
    ...
    return createBuildSafeResponse(
      'Cleanup Monitoring GET endpoint is available',
      {
        method: 'GET',
...
export async function POST(request: NextRequest) {
  try {
    ...
    return createBuildSafeResponse(
      'Cleanup Monitoring POST endpoint is available',
      {
        method: 'POST',
        body
      }
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return createBuildSafeResponse(
      'Cleanup Monitoring PUT endpoint is available',
      {
        method: 'PUT',
        body
      }
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return createBuildSafeResponse(
      'Cleanup Monitoring DELETE endpoint is available',
      {
        method: 'DELETE',
        params: Object.fromEntries(searchParams.entries())
      }
